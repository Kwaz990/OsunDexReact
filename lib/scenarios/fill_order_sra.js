...
var connect_1 = require("@0x/connect");
...
function scenarioAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var contractWrappers, web3Wrapper, _a, maker, taker, contractAddresses, zrxTokenAddress, etherTokenAddress, printUtils, makerAssetData, takerAssetData, makerAssetAmount, takerAssetAmount, txHash, txReceipt, makerZRXApprovalTxHash, takerWETHApprovalTxHash, takerWETHDepositTxHash, httpClient, randomExpiration, exchangeAddress, orderConfigRequest, orderConfig, order, orderHashHex, signature, signedOrder, orderbookRequest, response, sraOrder;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    print_utils_1.PrintUtils.printScenario('Fill Order Standard Relayer API');
                ...
                case 7:
                    ...
                    httpClient = new connect_1.HttpClient('http://localhost:3000/v2/');
                    ...
                    return [4 /*yield*/, httpClient.getOrderConfigAsync(orderConfigRequest, {
                            networkId: configs_1.NETWORK_CONFIGS.networkId
                        })];
                case 8:
                    orderConfig = _b.sent();
                    order = __assign({ salt: _0x_js_1.generatePseudoRandomSalt() }, orderConfigRequest, orderConfig);
                ...
                case 10:
                    ...
                    return [4 /*yield*/, httpClient.submitOrderAsync(signedOrder, { networkId: configs_1.NETWORK_CONFIGS.networkId })];
                case 11:
                    // Submit the order to the SRA Endpoint
                    _b.sent();
                    orderbookRequest = { baseAssetData: makerAssetData, quoteAssetData: takerAssetData };
                    return [4 /*yield*/, httpClient.getOrderbookAsync(orderbookRequest, { networkId: configs_1.NETWORK_CONFIGS.networkId })];
                case 12:
                    response = _b.sent();
                    if (response.asks.total === 0) {
                        throw new Error('No orders found on the SRA Endpoint');
                    }
                    sraOrder = response.asks.records[0].order;
                    printUtils.printOrder(sraOrder);
                    // Validate the order is Fillable given the maker and taker balances
                    return [4 /*yield*/, contractWrappers.exchange.validateFillOrderThrowIfInvalidAsync(sraOrder, takerAssetAmount, taker)];
                case 13:
                    // Validate the order is Fillable given the maker and taker balances
                    _b.sent();
                    return [4 /*yield*/, contractWrappers.exchange.fillOrderAsync(sraOrder, takerAssetAmount, taker, {
...
//# sourceMappingURL=fill_order_sra.js.map