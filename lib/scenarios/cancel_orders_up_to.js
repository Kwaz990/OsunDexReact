...
function scenarioAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var contractWrappers, web3Wrapper, _a, maker, taker, contractAddresses, zrxTokenAddress, etherTokenAddress, printUtils, makerAssetAmount, takerAssetAmount, makerAssetData, takerAssetData, randomExpiration, exchangeAddress, order1, order2, order3, order1Info, order2Info, order3Info, targetOrderEpoch, txHash, txReceipt;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    print_utils_1.PrintUtils.printScenario('Cancel Orders Up To');
                ...
                case 1:
                    ...
                    makerAssetAmount = new _0x_js_1.BigNumber(100);
                    takerAssetAmount = new _0x_js_1.BigNumber(10);
                    ...
                    order1 = {
                        ...
                        salt: new _0x_js_1.BigNumber(Date.now() - constants_1.TEN_MINUTES_MS),
                    ...
                    order2 = __assign({}, order1, { salt: new _0x_js_1.BigNumber(Date.now() - constants_1.ONE_MINUTE_MS) });
                    order3 = __assign({}, order1, { salt: new _0x_js_1.BigNumber(Date.now()) });
                    return [4 /*yield*/, contractWrappers.exchange.getOrderInfoAsync(order1)];
                case 2:
                    order1Info = _b.sent();
                    return [4 /*yield*/, contractWrappers.exchange.getOrderInfoAsync(order2)];
                case 3:
                    order2Info = _b.sent();
                    return [4 /*yield*/, contractWrappers.exchange.getOrderInfoAsync(order3)];
                case 4:
                    order3Info = _b.sent();
                    printUtils.printOrderInfos({ order1: order1Info, order2: order2Info, order3: order3Info });
                    targetOrderEpoch = order2.salt;
                    return [4 /*yield*/, contractWrappers.exchange.cancelOrdersUpToAsync(targetOrderEpoch, maker, {
                            gasLimit: configs_1.TX_DEFAULTS.gas
                        })];
                case 5:
                    txHash = _b.sent();
                    return [4 /*yield*/, printUtils.awaitTransactionMinedSpinnerAsync('cancelOrdersUpTo', txHash)];
                case 6:
                    txReceipt = _b.sent();
...
//# sourceMappingURL=cancel_orders_up_to.js.map