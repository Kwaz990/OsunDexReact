...
function scenarioAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var contractWrappers, web3Wrapper, _a, maker, taker, feeRecipient, contractAddresses, zrxTokenAddress, etherTokenAddress, printUtils, makerAssetAmount, takerAssetAmount, makerFee, takerFee, makerAssetData, takerAssetData, txHash, txReceipt, makerZRXApprovalTxHash, takerZRXApprovalTxHash, takerWETHApprovalTxHash, takerWETHDepositTxHash, randomExpiration, exchangeAddress, order, orderHashHex, signature, signedOrder;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    print_utils_1.PrintUtils.printScenario('Fill Order with Fees');
                ...
                case 1:
                    _a = _b.sent(), maker = _a[0], taker = _a[1], feeRecipient = _a[2];
                    ...
                    printUtils = new print_utils_1.PrintUtils(web3Wrapper, contractWrappers, { maker: maker, taker: taker, feeRecipient: feeRecipient }, { WETH: etherTokenAddress, ZRX: zrxTokenAddress });
...
//# sourceMappingURL=fill_order_fees.js.map