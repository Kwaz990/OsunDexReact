        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 13:
                    ...
                    fillData = transactionEncoder.fillOrderTx(signedOrder, takerAssetAmount);
                    takerTransactionSalt = _0x_js_1.generatePseudoRandomSalt();
                    executeTransactionHex = transactionEncoder.getTransactionHex(fillData, takerTransactionSalt, taker);
                    return [4 /*yield*/, _0x_js_1.signatureUtils.ecSignHashAsync(provider_engine_1.providerEngine, executeTransactionHex, taker)];
                case 14:
                    takerSignatureHex = _b.sent();
                    return [4 /*yield*/, contractWrappers.exchange.executeTransactionAsync(takerTransactionSalt, taker, fillData, takerSignatureHex, sender, {
...
//# sourceMappingURL=execute_transaction.js.map